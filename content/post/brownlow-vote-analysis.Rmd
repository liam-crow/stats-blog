...
pal <- c("grey","yellow", "orange", "red")
pal <- setNames(pal, c("0", "1", "2","3"))
```
...
plotly::plot_ly(aflt_2019_r1, x = ~kicks, y = ~marks, z = ~handballs, color = ~brownlow_votes, colors = pal, hoverinfo = 'text',
...
plotly::plot_ly(pca_comb, x = ~PC1, y = ~PC2, color = ~brownlow_votes, colors = pal, hoverinfo = 'text',
...
```{r, warning=F, message=F, echo=F}
plotly::plot_ly(pca_comb, x = ~PC1, y = ~PC2, z = ~PC3, color = ~brownlow_votes, colors = pal, size = 1, hoverinfo = 'text',
        text = ~paste(first_name, surname, '<br>Kicks:', kicks, '<br>Marks:', marks,
                      '<br>Hb:', handballs, '<br>Goals:', goals,
                      '<br>HO:', hit_outs, '<br>OP:', one_percenters)) %>% 
  plotly::add_markers() %>% 
...
plotly::plot_ly(umap_comb, x = ~V1, y = ~V2, color = ~brownlow_votes, colors = pal, hoverinfo = 'text',
        text = ~paste(first_name, surname, '<br>Kicks:', kicks, '<br>Marks:', marks,
                      '<br>Hb:', handballs, '<br>Goals:', goals,
                      '<br>HO:', hit_outs, '<br>OP', one_percenters)) %>%
  plotly::add_markers() %>% 
...
plotly::plot_ly(umap_comb_3, x = ~V1, y = ~V2, z = ~V3, color = ~brownlow_votes, colors = pal, size = 1, hoverinfo = 'text',
        text = ~paste(first_name, surname, '<br>Kicks:', kicks, '<br>Marks:', marks,
                      '<br>Hb:', handballs, '<br>Goals:', goals,
                      '<br>HO:', hit_outs, '<br>OP', one_percenters)) %>%
  plotly::add_markers() %>% 
...
plotly::plot_ly(pca_comb_scaled, x = ~PC1, y = ~PC2, z = ~PC3, color = ~brownlow_votes, colors = pal, size = 1, hoverinfo = 'text',
...
plotly::plot_ly(umap_comb_scaled, x = ~V1, y = ~V2, z = ~V3, color = ~brownlow_votes, colors = pal, size = 1, hoverinfo = 'text',
        text = ~paste(first_name, surname, '<br>Kicks:', round(kicks,3), '<br>Marks:', round(marks,3),
                      '<br>Hb:', round(handballs,3), '<br>Goals:', round(goals,3),
                      '<br>HO:', round(hit_outs,3), '<br>OP', round(one_percenters,3))) %>%
  plotly::add_markers() %>% 
