...
If you have any questions during this tutorial, you can tweet at me [\@crow_data_sci](https://twitter.com/crow_data_sci){target="blank"}. If you've got a useless stat, feel free to tweet at us [\@UselessStatsAFL](https://twitter.com/UselessStatsAFL){target="blank"} or message the page.
...
We'll be downloading R from here [https://cloud.r-project.org/](https://cloud.r-project.org/){target="blank"} and choose the version for your OS. I'd recommend all the default file locations and setup. If you are using a MAC OS, click `R-4.0.x.pkg` which is the executable.
